...
<body>
    <form action="./index.php" method="POST">
        <fieldset>
            <legend>Sequência Araya PHP POO</legend>
            <div class="inputs-select">
                <label for="numero_inicio">Selecione o valor inicial: </label>
...
?>
            ...
            <div class="inputs-select">
                <label for="numero_fim">Selecione o valor final: </label>
...
?>              </select>
            ...
            <div class="opcao">
                ...
                <div class="inputs">
                    ...
                    <div class="input">
                        <input type="radio" value="Pares" name="selecao" id="Pares">Apenas os números pares
                    </div>
                    <div class="input">
                        <input type="radio" value="Impares" name="selecao" id="Impares">Apenas os números ímpares
                    </div>
                </div>
                </div>
                <div class="input">
